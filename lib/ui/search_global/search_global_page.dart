...
class SearchGlobalPage extends StatefulWidget {
  ...
  const SearchGlobalPage({required this.joinedTeam, required this.drawerChatList});
            ...
            child: TXPullToRefreshWidget(
              ...
              body: ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  ...
                  final member =
                      Injector.instance.inMemoryData.getMember(message?.uid ?? "");
                  return Container(
                              ...
                              children: [
                                Container(
                                  child: TXUserDateMessageWidget(
                                    ...
                                    userText: member?.profile?.fullNameWithUsername ??
                                        R.string.appName,
                                    dateText: CalendarUtils.showInFormat(
                                            R.string.dateFormat4, message?.ts)
                                        ?.toLowerCase() ?? "",
                                  ),
                                ...
                                Container(
                                  ...
                                  child: TXMessageBodyWidget(
                                    ...
                                    onLinkTap: (link) async {
                                      ...
                                      } else if (link.startsWith("#file-comment")) {
                                        bloc.getChannelFromId(message.cid).then((value) {
                                          if(value != null) {
