...
class TXDrawerChatItemWidget extends StatefulWidget {
  ...
  const TXDrawerChatItemWidget({Key? key, required this.drawerChatModel, required this.onTap})
      : super(key: key);
              ...
              child: Row(
                children: [
                  _drawerChatModel.channelModel?.isPrivateGroup == true
                      ...
                      : Container(),
                  SizedBox(
                    width: _drawerChatModel.channelModel?.isPrivateGroup == true ? 5 : 0,
                  ),
                  Expanded(
                    child: TXTextWidget(
            ...
            children: <Widget>[
              Container(
                ...
                child: TXNetworkImage(
                  height: 40,
                  width: 40,
                  imageUrl: _drawerChatModel.memberModel?.photo ?? "",
                  forceLoad: true,
              ...
              Positioned(
                child: TXUserPresenceWidget(
                  userPresence: _drawerChatModel.memberModel?.userPresence ?? UserPresence.out,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          Flexible(
                            child: TXTextWidget(
                              text:
                                  "${_drawerChatModel.memberModel?.profile?.fullName}",
                              color: _drawerChatModel.isSelected
                                  ? colors.activeItemText
                                  : colors.subtextColor,
                              fontWeight: FontWeight.w500,
                          ...
                          !(_drawerChatModel
                                      .memberModel?.statusIcon.isEmpty ==
                                  true)
                              ? InkWell(
                      ...
                      TXTextWidget(
                        text:
                            "@${_drawerChatModel.memberModel?.profile?.name}",
