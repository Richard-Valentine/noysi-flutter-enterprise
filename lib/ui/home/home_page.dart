...
class _HomeState extends StateWithBloC<HomePage, HomeBloC>
  ...
  void initState() {
    ...
    _appLinksContentSubscription = appLinksContentController.listen((Uri? uri) {
      if (uri != null) {
        if (uri.host.contains("meet.noysi.com") ||
...
//                  Fluttertoast.showToast(msg: drawerChat.title.toString());
                                      ...
                                      TaskPage(
                                        ...
                                        appBarTitle: selectedDrawerItem == null
                                            ...
                                            : selectedDrawerItem
                                                    ...
                                                    DrawerHeaderChatType
                                                        .Message1x1
                                                ? "@${selectedDrawerItem.memberModel!.profile!.name.toLowerCase().trim()}"
                                ...
                                onNavigationOptionTap: (option) async {
                                  ...
                                  if (option ==
                                    ...
                                    NavigationUtils.push(context, InvitePage());
                                  } else if (option ==
      ...
      child: channel.isM1x1
          ? Column(
              ...
              children: [
                ...
                TXTextWidget(
                  ...
                  text: R.string.hereStartsYourMessagesWith(bloc.inMemoryData
                          .getMember(channel.other)
                          ?.profile
                          ?.name ??
                      ""),
                ),
          ...
          : Column(
              ...
              children: [
                ...
                TXTextWidget(
                  textAlign: TextAlign.center,
                  text: R.string.thisChannelIsManagedBy(bloc.inMemoryData
                          .getMember(channel.uid!)
                          ?.profile
                          ?.name ??
                      ""),
                ),
    ...
    if (threadMetaParent != null && threadMetaChild == null) {
      threadMetaParent.participants.forEach((element) {
        threadSectionList.add(TXNetworkImage(
          ...
          userBorderRadius: true,
          imageUrl:
              members.firstWhereOrNull((m) => m.id == element)?.photo ?? "",
          placeholderImage: Image.asset(R.image.logo),
        ));
      });
                    ...
                    Container(
                      margin: EdgeInsets.only(
                          top: showMessageMemberInfo &&
                                  bloc.getMemberName(member).isUpperCase()
                              ? 3.5
                      ...
                      child: showMessageMemberInfo
                          ? TXNetworkImage(
                              imageUrl: bloc.getMemberPhoto(member),
                              userBorderRadius: true,
        ...
        child: Column(
          ...
          children: <Widget>[
            showMessageMemberInfo
                ? Container()
                : TXTextWidget(
                    text: bloc.getMemberName(memberModel) ?? "",
                    color: R.color.blackColor,
                    fontWeight: FontWeight.bold,
                    size: 16,
                  ),
