...
void txShowStatusSelector(BuildContext context,
  ...
  final keyFormName = new GlobalKey<FormState>();
  ...
  suggestions.forEach((key, value) {
    ...
    if (key != suggestions.keys.toList()[suggestions.length - 1])
      suggestionWidgets.add(SizedBox(height: 10));
  });
              ...
              Expanded(
                  child: Form(
                      ...
                      child: Container(
                        ...
                        contentPadding: EdgeInsets.only(left: 5, top: 7),
...
Future<dynamic> txShowMeetingOptionsDialog(BuildContext context,
  ...
  return showBlurDialog(
      ...
      builder: (context) => AlertDialog(
            ...
            contentPadding:
                EdgeInsets.only(top: 25, left: 15, right: 10, bottom: 0),
            title: TXTextWidget(
                  ...
                  Container(
                    child: EmojiPicker(
                      config: Config(
                          ...
                          showRecentsTab: true,
                          recentsLimit: 28,
                          noRecentsText: R.string.noRecents,
