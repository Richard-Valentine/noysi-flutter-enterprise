      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              TXTextWidget(
                text: R.string.appName.toUpperCase(),
                color: Colors.black,
              ),
              // SizedBox(
              //   width: 10,
          ...
          GridView.count(
                  ...
                  children: <Widget>[
                    bloc.fileModelUI.noysiChannel?.joined == true &&
                            bloc.fileModelUI.noysiChannel?.open == true
                        ? TXFolderWidget(
          ...
          isOwner || isAdmin
              ? Container(
                  ...
                  child: TXMenuOptionItemWidget(
                    ...
                    onTap: () async {
                      await NavigationUtils.pop(context);
                      _showDialogDelete(context: context, fileId: file.id ?? "");
                    },
                  ),
                )
              : Container()
