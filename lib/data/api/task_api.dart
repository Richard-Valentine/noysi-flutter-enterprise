...
class TaskApi extends BaseApi implements ITaskApi {
 ...
 //  }
  ...
  Future<List<TaskLabelModel>> getLabels(String teamId, String channelId,
    ...
    String path =
        "${Endpoint.teams}/$teamId${Endpoint.channels}/$channelId/labels?max=$max&offset=$offset&q=$query";
  ...
  Future<List<TaskMileStoneModel>> getMilestones(
    ...
    String path =
        "${Endpoint.teams}/$teamId${Endpoint.channels}/$channelId/milestones?max=$max&offset=$offset&q=$query&status=$status";
