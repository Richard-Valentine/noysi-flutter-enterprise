...
class TeamConverter implements ITeamConverter {
  ...
  TeamModel fromJson(Map<String, dynamic> json) {
    final TeamModel model = TeamModel(
        ...
        uid: json["uid"],
        trial: json["trial"],
        cname: json["cname"] != null ? fromJsonTeamCname(json["cname"]) : null,
  ...
  TeamCname fromJsonTeamCname(Map<String, dynamic> json) {
    return TeamCname(
        id: json['id'],
        domain: json['domain'],
        enabled: json.containsKey('status') && json['status'] != null &&
  ...
  WhiteBrandConfig fromJsonWhiteBrandConfig(Map<String, dynamic> json) {
    final socialMedia = json.containsKey('social-media') && json['social-media'] != null ? json['social-media'] as List<dynamic> : [];
